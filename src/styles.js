const styles = {
  ...
  heroHeadText:
    'text-white font-poppins lg:text-[70px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-2',
  heroSubText:
    'text-white font-poppins lg:text-[24px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[36px]',
